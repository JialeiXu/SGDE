...
--restore_ckpt models/raftstereo-middlebury.pth --corr_implementation alt --mixed_precision -l=datasets/StereoMatch_Result/000189/CAMERA_01/l/*.png -r=datasets/StereoMatch_Result/000189/CAMERA_01/r/*.png 
--restore_ckpt models/raftstereo-middlebury.pth --corr_implementation alt --mixed_precision -l=datasets/l.png -r=datasets/r.png
```
Or for ETH3D:
```Shell
